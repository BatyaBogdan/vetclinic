    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <a class="nav-link text-white" href="doctor/orders">Заявки</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="doctor/calls">Журнал звонков</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="doctor/feedback">История обратной связи</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="doctor/appleals">Журнал обращений</a>
          </li>
        </ul>
      </div>
    </div>
