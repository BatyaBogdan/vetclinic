<body>
  ...
  <nav class="navbar navbar-expand-md bg-dark">
    <div class="container">
      <a class="navbar-brand text-white" href="main/">Панель врача</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <a class="nav-link text-white" href="chief/complaints">Жалобы</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="chief/report_services">Отчёт по оказанным услугам</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="chief/report_staff">Отчёт по персоналу</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="chief/report_ appeals">Отчёт по заболеваниям</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="client/services">Услуги</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="client/appeal">Записаться к врачу</a>
          </li>
          <li class="nav-item">
        ...
        <div class="flex-shrink-0 dropdown">
          ...
          <ul class="dropdown-menu text-small shadow">
            <li><a class="dropdown-item" href="client/">Мои заявки</a></li>
            <li><a class="dropdown-item" href="client/">Мои обращения</a></li>
